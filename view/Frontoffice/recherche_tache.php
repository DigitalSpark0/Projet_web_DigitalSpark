...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>Chercher une tache</title>
        ...
        <div class= "container">
            <div class="row">
              ...
              <div class="input-group mb-3">
                <input type="text" class="form-control me-3" name="idtache" placeholder="Donnez Le Priority" aria-label="Recherche" aria-describedby="button-addon2">
                <button class="btn btn-primary " type="submit" id="button-addon2">chercher</button>
              </div>
            </form>
            </div>
            <?php $idtchercher = isset($_POST["idtache"]) ?$_POST["idtache"]:'erreur'; 
            $cherchertache = new tacheController();
            $tchercher = $cherchertache->listcommandechercher($idtchercher);
            ?>
            <?php foreach ($tchercher as $tache){ ?>
                    <li class="list-group-item border-5 d-flex p-4 mb-2 bg-gray-200 border-radius-lg">
                    <div class="d-flex flex-column">
                      <h2 class="mb-3 text-sm font-weight-bold">IDt:  <?= $tache['IDt'];?></h2>
                      <span class="mb-2 text-xs">IDp: <span class="text-dark ms-sm-2" name="idpse"><?= $tache['IDp'];?></span></span>
                      <span class="mb-2 text-xs">Nomtache: <span class="text-dark ms-sm-2" name="idsse"><?= $tache['Nomtache'];?></span></span>
                      <span class="mb-2 text-xs">DescriptionT: <span class="text-dark ms-sm-2" name="da"><?= $tache['DescriptionT'];?> </span></span>
                      <span class="text-xs">Deadline: <span class="text-dark ms-sm-2" name="st"><?= $tache['Deadline'];?></span></span>
                      <span class="text-xs">Priority: <span class="text-dark ms-sm-2" name="mo"><?= $tache['Priority'];?></span></span>
                      <span class="text-xs">Notes: <span class="text-dark ms-sm-2" name="no"><?= $tache['Notes'];?></span></span>
                  </div>
                    </li>
                <?php } ?> 
                                   </div> 
