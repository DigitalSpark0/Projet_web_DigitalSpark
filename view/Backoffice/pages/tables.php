...
$listrep= $reponceC->listereponses();
?>
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">id reclamation</th>
                  ...
                  <tbody>
                  <?php
        foreach ($list as $reclamationC) {
          foreach ($listrep as $reponceC) {
        ?>
                    <tr>
                      <td>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success"><?= $reclamationC['description']; ?></span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?= $reclamationC['dater']; ?></span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?= $reponceC['contenu']; ?></span>
                      </td>
                      <td align="center">
                <form method="POST" action="updateRep.php?idr=<?php echo $reclamationC['idr']; ?>">
                        <input type="submit" name="update" value="Update">
                        <input type="hidden" value=<?PHP echo $reclamationC['idr']; ?> name="idr">
                    </form>
                </td>
