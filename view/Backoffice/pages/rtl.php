...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white  active bg-gradient-primary " href="../pages/rtl.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container">
        <!-- Bouton pour afficher la page ajout.php -->
        <button class="btn btn-primary" onclick="window.location.href = 'candidature.php';">Afficher La Liste Des Candidatures</button>
...
<form class="d-none d-md-flex ms-4" method="POST">
    ...
    <input type="hidden" name="type" value="search">
                ...
                <form class="d-none d-md-flex ms-4" action="" method="POST" >
                    <button type="tri" class="btn btn-primary m-2" value="tri" name="type" >trier le panier</button>
                </form>
...
?>
                        ...
                        <form method="POST" action="generatepdf1.php">
        <input type="hidden" name="type" value="pdf">
        <button type="submit" class="">Generate PDF</button>
        <a href="./statistique1.php">
    ...
    <div class="container">
        <!-- Bouton pour afficher la page ajout.php -->
        <button class="btn btn-primary" onclick="window.location.href = 'ajout.php';">Ajouter Offre</button>
