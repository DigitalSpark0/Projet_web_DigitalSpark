            ...
            <div class="container">
                ...
                <div class="row mb-4">
                    ...
                    ?>
                        ...
                        <forum>
                          <a class="btn bg-gradient-dark mb-0" type="delete" href="supprimer_taches.php?id=<?php echo $tache['IDt']; ?>"><i class="material-icons text-sm">remove</i>Delete</a>
                          <a class="btn bg-gradient-dark mb-0" type="update" href="modifier_project.php?id=<?php echo $tache['IDp']; ?>"><i class="material-icons text-sm">add</i>Update</a>
                        </forum>
                        <?php }
                        ?>
                      </div>
