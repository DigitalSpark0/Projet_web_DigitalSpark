...
<!-------------------------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <div class="container-fluid py-4">
      <div class="row">
        ...
        <form id="user" action="ajouter_user.php" method="post" class="text-center" onsubmit="return validateForm()">
            ...
            <button class="btn bg-gradient-dark mb-0" type="submit"><i class="material-icons text-sm"></i>&nbsp;&nbsp;Sign up</button>
        </form>
    </div>
    ...
    <script>
        ...
        function validateForm() {
            ...
            if (prenom.trim() === "") {
                document.getElementById("prenom-error").innerText = "Please enter your first name";
                isValid = false;
            } else {
            ...
            if (nom.trim() === "") {
                document.getElementById("nom-error").innerText = "Please enter your last name";
                isValid = false;
            } else {
            ...
            if (role.trim() === "") {
                document.getElementById("role-error").innerText = "Please choose a role";
                isValid = false;
            } else {
