...
<html>
  ...
  <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
              ...
              <div class="card mt-4">
                <div class="card-header pb-5 p-3">
                  ...
                  <section align="center">
                      <label for="titre_ser"></label>
                      <input type="hidden" id="idservv" name="idserv" value="<?php echo $idserv;?>">
                      <br><br>
                      ...
                      <input type="hidden" id="idcc" name="idcc" value="<?php echo $idcommande;?>"><br><br>
    ...
    input[type="text"] {
        ...
        margin-bottom: 15px; /* Ajouter un espacement en bas */
        border: 1px solid #ccc; /* Ajouter une bordure */
        border-radius: 5px; /* Ajouter des coins arrondis */
        box-sizing: border-box; /* Inclure la bordure et le remplissage dans la largeur */
    }
