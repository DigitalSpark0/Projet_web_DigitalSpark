...
class QRencode {
    ...
    // Méthode de création de l'instance de QRencode
    public static function factory($level = QR_ECLEVEL_L, $size = 3, $margin = 4, $back_color = 0xFFFFFF, $fore_color = 0x000000, $cmyk = false)
    {
        ...
        // La propriété $cmyk a été supprimée car elle est obsolète
        // $enc->cmyk = isset($cmyk) ? $cmyk : null;
        
        // Définition du niveau de correction d'erreur
        switch ($level.'') {
            case '0':
            case '1':
            case '2':
    ...
    // Méthode pour encoder le texte brut en code QR brut
    ...
    // Méthode pour encoder le texte brut en code QR
    ...
    // Méthode pour encoder le texte brut en code QR au format PNG
    ...
    // Méthode pour encoder le texte brut en code QR au format EPS
    public function encodeEPS($intext, $outfile = false, $saveandprint = false) 
    {
        try {
            ...
            QRvect::eps($tab, $outfile, min(max(1, $this->size), $maxSize), $this->margin, $saveandprint, $this->back_color, $this->fore_color);
    ...
    // Méthode pour encoder le texte brut en code QR au format SVG
